...
OBJECT_ENTRY(CLSID_CustomMCastProtocol, CCustomMCastProtocol)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_MCastProtocolLib);
...
STDAPI DllRegisterServer(void)
{
   ...
   if (FAILED(hRes))
      return hRes;
   hRes = pManager->RegisterProtocol(SZ_MCASTPROTOCOL, CLSID_CustomMCastProtocol);
   if (FAILED(hRes))
   {
      pManager->Release();
      return hRes;
