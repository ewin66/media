...
namespace FutureConcepts.Media.Client.StreamViewer.Graphs
{
    ...
    /// </summary>
    public class LeadToolsRTSPGraph : BaseGraph, ILMVUserCallback
    {
        ...
        public LeadToolsRTSPGraph(string url) : base(url)
        {
        ...
        {
            if (_videoCallbackFilter != null)
            {
                Marshal.FinalReleaseComObject(_videoCallbackFilter);
                _videoCallbackFilter = null;
            }
...
//            base.Run();
        ...
        private void AddRTSPSource()
        {
            _netSrc = AddFilterByName(_graphBuilder, FilterCategory.LegacyAmFilterCategory, "LEAD RTSP Source");
        ...
        private void OnModuleNotify(int x, ref Guid guid)
        {
        }
    }
}
