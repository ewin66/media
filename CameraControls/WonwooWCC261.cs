...
namespace FutureConcepts.Media.CameraControls
{
    ...
    /// </summary>
    public class WonwooWCC261 : PelcoD, IPresetProviderItems
    {
        /// <summary>
        ...
        private TimerCallback _stopTimerDelegate;
        ...
        public override void PanTiltAbsolute(double panAngle, double tiltAngle)
        {
            ...
            if (panAngle != 0)
            {
                ...
                _cameraControl.CurrentPanAngle = 0;
            }
            ...
            if (tiltAngle != 0)
            {
                ...
                _cameraControl.CurrentTiltAngle = 0;
            }
        }
        ...
        public override void ZoomAbsolute(double zoomPosition)
        {
            if (zoomPosition != 0)
            {
                ...
                _cameraControl.CurrentZoomPosition = 0;
            }
        }
