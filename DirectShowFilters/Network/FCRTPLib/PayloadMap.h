...
public:
	...
	*/
	...
	/*
		...
		payloadType		[in]	RTP payload type
		majortype		[in]	DirectShow major type
		subtype			[in]	DirectShow sub type
	*/
	void AddMapping(PayloadType payloadType, const GUID & majortype, const GUID & subtype);
	/*
	...
	*/
	...
	/*
		Maps all known GUIDs for H.264 NALU (RFC3984) to the specified payload type
		payloadType	[in]	dynamically negotiated payload type for RFC3984
	*/
	void AddMappingForH264(PayloadType payloadType);
