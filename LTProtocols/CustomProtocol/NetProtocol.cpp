...
OBJECT_ENTRY(CLSID_CustomProtocol, CCustomProtocol)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_NetProtocolLib);
...
STDAPI DllRegisterServer(void)
{
   ...
   if (FAILED(hRes))
      return hRes;
   hRes = pManager->RegisterProtocol(SZ_CUSTOMPROTOCOL, CLSID_CustomProtocol);
   if (FAILED(hRes))
   {
      pManager->Release();
      return hRes;
