...
{
    public class WinTV150: WinTVAnalogBase
    {
        public WinTV150(StreamSourceInfo sourceConfig, OpenGraphRequest openGraphRequest) : base(sourceConfig, openGraphRequest)
        {
