...
namespace FutureConcepts.Media.DirectShowLib
{
    ...
    {
        /// <summary>
        /// Generates a MediaType GUID for a Four CC code
        /// </summary>
        /// <param name="fourCC">four cc to get MediaType GUID for</param>
        /// <returns>the Guid for the given Four CC</returns>
        public static Guid FromFourCC(string fourCC)
        {
            return new Guid(DsUtils.MakeFourCC(fourCC), 0x0000, 0x0010, 0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71);
        }
    ...
    static public class MediaSubType
    {
        ...
        /// <summary> LeadTools Stream Format - LTSF </summary>
        public static readonly Guid LeadToolsStreamFormat = new Guid("8256426B-28BF-4EBD-8EF4-306913875F34");

        /// <summary> Ogg Media DirectShow Format </summary>
        public static readonly Guid OGM = new Guid("D2855FA9-61A7-4DB0-B979-71F297C17A04");
